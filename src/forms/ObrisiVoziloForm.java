 ...
 * @author Stefan
 */
public class ObrisiVoziloForm extends javax.swing.JDialog {

    /**
     * Creates new form ObrisiVoziloForm
     */
    public ObrisiVoziloForm(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Obrisi Vozilo");

        tblVozila.setFont(new java.awt.Font("Segoe UI", 0, 14)); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ObrisiVoziloForm.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ObrisiVoziloForm dialog = new ObrisiVoziloForm(new javax.swing.JFrame(), true);
